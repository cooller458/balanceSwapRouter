...
import '@balanceswap/v3-periphery/contracts/base/PeripheryImmutableState.sol';
import '@balanceswap/v3-core/contracts/libraries/SafeCast.sol';
import '@balanceswap/v3-core/contracts/libraries/TickMath.sol';
import '@balanceswap/v3-core/contracts/libraries/TickBitmap.sol';
import '@balanceswap/v3-core/contracts/interfaces/IBalanceSwapV3Pool.sol';
import '@balanceswap/v3-core/contracts/interfaces/callback/IBalanceSwapV3SwapCallback.sol';
import '@balanceswap/v3-periphery/contracts/libraries/Path.sol';
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IBalanceSwapV3SwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IBalanceSwapV3Pool;
    ...
    */
    ...
    /// @inheritdoc IBalanceSwapV3SwapCallback
    function balanceSwapV3SwapCallback(
        int256 amount0Delta,
        int256 amount1Delta,
        bytes memory path
        ...
        IBalanceSwapV3Pool pool = SmartRouterHelper.getPool(deployer, tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IBalanceSwapV3Pool pool = SmartRouterHelper.getPool(deployer, params.tokenIn, params.tokenOut, params.fee);
